  ...
  return (
    ...
    >
      <g stroke="#f5b94d" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" fill="none">
        ...
        {/* Left horn (existing) - nostril/muzzle was mislabeled, this is actually horn */}
        ...
        {/* RIGHT HORN (NEW - was missing) */}
        <motion.path d="M 470.0,28.0 C 472.0,28.5 478.0,45.0 482.0,52.0 C 486.0,59.0 492.0,65.0 495.0,68.0 C 498.0,71.0 499.0,72.5 497.0,74.0 C 495.0,75.5 488.0,74.0 483.0,72.0 C 478.0,70.0 473.0,66.0 470.0,62.0 C 467.0,58.0 465.0,52.0 464.0,46.0 C 463.0,40.0 468.0,27.5 470.0,28.0 Z" initial={{ pathLength: 0 }} animate={drawAnimate} transition={drawTransition} />
